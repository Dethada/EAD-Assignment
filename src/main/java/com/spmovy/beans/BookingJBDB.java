...
public class BookingJBDB {
    public static boolean insertseats(String hall_column, String hall_row) throws SQLException {
        DatabaseUtils db = new DatabaseUtils();
        int count = db.executeUpdate("INSERT INTO seats VALUES (?,?)",hall_column,hall_row);
        db.closeConnection();
        return count == 1;
    }
