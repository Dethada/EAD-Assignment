    ...
    <div class="container">
        ...
        <table class="table">
            ...
            <tr id="<%=seat+bookingid%>">
                ...
                <td><i onclick="return removeSeat('<%=seat%>', '<%=bookingid%>', <%=price%>)" style="cursor: pointer;"
        ...
        <p class="mb-2" style="border-bottom: solid 1px">Grand Total: <span id="grandtotal"><%=totalgrandtotal%><span>
        </p>
        <h3 class="mt-2">Personal details</h3>
        <p class="mb-2">Name: <%=user.getName()%>
        </p>
        <p class="mb-2">Email: <%=user.getEmail()%>
        </p>
        <p class="mb-2">Contact Number: <%=user.getContact()%>
        </p>
        <%
        ...
        %>
        <p class="mb-2">Credit Card Number (Last four digits): <%=replace%>-<%=lastfour%>
        </p>
