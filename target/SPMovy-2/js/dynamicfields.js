$(document).ready(function () {
    ...
    $(".add-more").click(function (e) {
        ...
        next = next + 1;
        var newIn = '<input class="form-control awesomplete" placeholder="Genre" id="field' + next + '" name="genre" list="GenreList">';
        var newInput = $(newIn);
    ...
    $(".add-more2").click(function (e) {
        ...
        next2 = next2 + 1;
        var newIn = '<input class="form-control awesomplete" placeholder="Actor" id="fieldz' + next2 + '" name="actor" list="ActorList">';
        var newInput = $(newIn);
